...
module SpecHelpers
  ...
  def make_invoice_items
    ...
    InvoiceItem.create(item_id: item1.id, invoice_id: invoice1.id, unit_price: 12345)
    ...
    InvoiceItem.create(item_id: item2.id, invoice_id: invoice2.id, unit_price: 12345)
    ...
    item3 = Item.create(name: "yoyo", description: "blue", unit_price: 12343)
    InvoiceItem.create(item_id: item3.id, invoice_id: invoice3.id, unit_price: 12343)
    ...
    item4 = Item.create(name: "sock", description: "nice", unit_price: 12532)
    InvoiceItem.create(item_id: item4.id, invoice_id: invoice4.id, unit_price: 12532)
  end
  ...
  def make_items
    Item.create(name: "tool", description: "really neat", unit_price: 12345)
    Item.create(name: "pants", description: "soft", unit_price: 12342)
    Item.create(name: "sock", description: "black", unit_price: 12332)
    Item.create(name: "sock", description: "red", unit_price: 12332)
  end
