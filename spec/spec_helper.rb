...
module SpecHelpers
  ...
  def make_transactions
    ...
    InvoiceItem.create(item_id: item.id, invoice_id: invoice2.id, quantity: 1, unit_price: 123.45)
  ...
  def make_transactions_pending
    ...
    Transaction.create(invoice_id: invoice1.id, credit_card_number: "4654405418249635", result: "failed")
